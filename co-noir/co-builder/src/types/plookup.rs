...
pub(crate) enum BasicTableId {
    ...
    Sha256Base16,
    Sha256Base16Rotate2,
    // Sha256Base16Rotate6, Sha256Base16Rotate7, Sha256Base16Rotate8 removed in bb 4.2.0
    ...
    // Bn254 basic/endo table IDs removed in bb 4.2.0
    Secp256k1XloBasic,
    Secp256k1XhiBasic,
    Secp256k1YloBasic,
    Secp256k1YhiBasic,
...
pub(crate) enum MultiTableId {
    ...
    Uint32And,
    Uint64And,
    // Bn254 multi-table IDs removed in bb 4.2.0
    Secp256k1Xlo,
    Secp256k1Xhi,
    Secp256k1Ylo,
    Secp256k1Yhi,
    ...
    BlakeXorRotate8,
    BlakeXorRotate7,
    // PedersenIv removed — not present in bb's MultiTableId
    HonkDummyMulti,
    KeccakThetaOutput,
    KeccakChiOutput,
    KeccakFormatInput,
