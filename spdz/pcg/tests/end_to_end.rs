...
fn pcg_preprocessing_drives_spdz_mul() {
    ...
    let p0_prep = PcgPreprocessing::<Fr>::new_ring_lpn_insecure(0, shared_seed, 12, 4, 0xA11CE);
    let p1_prep = PcgPreprocessing::<Fr>::new_ring_lpn_insecure(1, shared_seed, 12, 4, 0xA11CE);
...
fn pcg_preprocessing_drives_multiple_muls() {
    ...
    let p0_prep = PcgPreprocessing::<Fr>::new_ring_lpn_insecure(0, shared_seed, 14, 8, 0xBEEF);
    let p1_prep = PcgPreprocessing::<Fr>::new_ring_lpn_insecure(1, shared_seed, 14, 8, 0xBEEF);
...
/// Ring-LPN PCG: PcgPreprocessing backed by the sub-linear Ring-LPN PCG
